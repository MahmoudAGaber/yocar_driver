...
class Variables$Mutation$markPayoutAccountAsDefault {
  factory Variables$Mutation$markPayoutAccountAsDefault({required String id}) =>
      Variables$Mutation$markPayoutAccountAsDefault._({
        r'id': id,
      });

  Variables$Mutation$markPayoutAccountAsDefault._(this._$data);

  factory Variables$Mutation$markPayoutAccountAsDefault.fromJson(
      Map<String, dynamic> data) {
    final result$data = <String, dynamic>{};
    final l$id = data['id'];
    result$data['id'] = (l$id as String);
    return Variables$Mutation$markPayoutAccountAsDefault._(result$data);
  }
  ...
  CopyWith$Variables$Mutation$markPayoutAccountAsDefault<
          Variables$Mutation$markPayoutAccountAsDefault>
      get copyWith => CopyWith$Variables$Mutation$markPayoutAccountAsDefault(
            this,
            (i) => i,
          );
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Variables$Mutation$markPayoutAccountAsDefault) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
abstract class CopyWith$Variables$Mutation$markPayoutAccountAsDefault<TRes> {
  factory CopyWith$Variables$Mutation$markPayoutAccountAsDefault(
    Variables$Mutation$markPayoutAccountAsDefault instance,
    TRes Function(Variables$Mutation$markPayoutAccountAsDefault) then,
  ) = _CopyWithImpl$Variables$Mutation$markPayoutAccountAsDefault;

  factory CopyWith$Variables$Mutation$markPayoutAccountAsDefault.stub(
          TRes res) =
      _CopyWithStubImpl$Variables$Mutation$markPayoutAccountAsDefault;

  TRes call({String? id});
}

class _CopyWithImpl$Variables$Mutation$markPayoutAccountAsDefault<TRes>
    implements CopyWith$Variables$Mutation$markPayoutAccountAsDefault<TRes> {
  _CopyWithImpl$Variables$Mutation$markPayoutAccountAsDefault(
    this._instance,
    this._then,
  );

  final Variables$Mutation$markPayoutAccountAsDefault _instance;

  final TRes Function(Variables$Mutation$markPayoutAccountAsDefault) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? id = _undefined}) =>
      _then(Variables$Mutation$markPayoutAccountAsDefault._({
        ..._instance._$data,
        if (id != _undefined && id != null) 'id': (id as String),
      }));
}

class _CopyWithStubImpl$Variables$Mutation$markPayoutAccountAsDefault<TRes>
    implements CopyWith$Variables$Mutation$markPayoutAccountAsDefault<TRes> {
  _CopyWithStubImpl$Variables$Mutation$markPayoutAccountAsDefault(this._res);
...
class Mutation$markPayoutAccountAsDefault {
  Mutation$markPayoutAccountAsDefault({
    required this.markPayoutAccountAsDefault,
    this.$__typename = 'Mutation',
  });

  factory Mutation$markPayoutAccountAsDefault.fromJson(
      Map<String, dynamic> json) {
    final l$markPayoutAccountAsDefault = json['markPayoutAccountAsDefault'];
    final l$$__typename = json['__typename'];
    return Mutation$markPayoutAccountAsDefault(
      markPayoutAccountAsDefault: Fragment$PayoutAccount.fromJson(
          (l$markPayoutAccountAsDefault as Map<String, dynamic>)),
      $__typename: (l$$__typename as String),
    );
  }

  final Fragment$PayoutAccount markPayoutAccountAsDefault;

  final String $__typename;

  Map<String, dynamic> toJson() {
    final _resultData = <String, dynamic>{};
    final l$markPayoutAccountAsDefault = markPayoutAccountAsDefault;
    _resultData['markPayoutAccountAsDefault'] =
        l$markPayoutAccountAsDefault.toJson();
    final l$$__typename = $__typename;
    _resultData['__typename'] = l$$__typename;
    return _resultData;
  }
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Mutation$markPayoutAccountAsDefault) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$markPayoutAccountAsDefault = markPayoutAccountAsDefault;
    final lOther$markPayoutAccountAsDefault = other.markPayoutAccountAsDefault;
    if (l$markPayoutAccountAsDefault != lOther$markPayoutAccountAsDefault) {
      return false;
    }
    final l$$__typename = $__typename;
    final lOther$$__typename = other.$__typename;
...
extension UtilityExtension$Mutation$markPayoutAccountAsDefault
    on Mutation$markPayoutAccountAsDefault {
  CopyWith$Mutation$markPayoutAccountAsDefault<
          Mutation$markPayoutAccountAsDefault>
      get copyWith => CopyWith$Mutation$markPayoutAccountAsDefault(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Mutation$markPayoutAccountAsDefault<TRes> {
  factory CopyWith$Mutation$markPayoutAccountAsDefault(
    Mutation$markPayoutAccountAsDefault instance,
    TRes Function(Mutation$markPayoutAccountAsDefault) then,
  ) = _CopyWithImpl$Mutation$markPayoutAccountAsDefault;

  factory CopyWith$Mutation$markPayoutAccountAsDefault.stub(TRes res) =
      _CopyWithStubImpl$Mutation$markPayoutAccountAsDefault;

  TRes call({
    Fragment$PayoutAccount? markPayoutAccountAsDefault,
    String? $__typename,
  });
  CopyWith$Fragment$PayoutAccount<TRes> get markPayoutAccountAsDefault;
}

class _CopyWithImpl$Mutation$markPayoutAccountAsDefault<TRes>
    implements CopyWith$Mutation$markPayoutAccountAsDefault<TRes> {
  _CopyWithImpl$Mutation$markPayoutAccountAsDefault(
    this._instance,
    this._then,
  );

  final Mutation$markPayoutAccountAsDefault _instance;

  final TRes Function(Mutation$markPayoutAccountAsDefault) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({
    Object? markPayoutAccountAsDefault = _undefined,
    Object? $__typename = _undefined,
  }) =>
      _then(Mutation$markPayoutAccountAsDefault(
        markPayoutAccountAsDefault: markPayoutAccountAsDefault == _undefined ||
                markPayoutAccountAsDefault == null
            ? _instance.markPayoutAccountAsDefault
            : (markPayoutAccountAsDefault as Fragment$PayoutAccount),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
  ...
  CopyWith$Fragment$PayoutAccount<TRes> get markPayoutAccountAsDefault {
    final local$markPayoutAccountAsDefault =
        _instance.markPayoutAccountAsDefault;
    return CopyWith$Fragment$PayoutAccount(local$markPayoutAccountAsDefault,
        (e) => call(markPayoutAccountAsDefault: e));
  }
}

class _CopyWithStubImpl$Mutation$markPayoutAccountAsDefault<TRes>
    implements CopyWith$Mutation$markPayoutAccountAsDefault<TRes> {
  _CopyWithStubImpl$Mutation$markPayoutAccountAsDefault(this._res);
...
const documentNodeMutationmarkPayoutAccountAsDefault =
    DocumentNode(definitions: [
  OperationDefinitionNode(
    type: OperationType.mutation,
    name: NameNode(value: 'markPayoutAccountAsDefault'),
    variableDefinitions: [
    ...
    selectionSet: SelectionSetNode(selections: [
      FieldNode(
        ...
        arguments: [
          ArgumentNode(
            name: NameNode(value: 'payoutMethodId'),
...
Mutation$markPayoutAccountAsDefault
    _parserFn$Mutation$markPayoutAccountAsDefault(Map<String, dynamic> data) =>
        Mutation$markPayoutAccountAsDefault.fromJson(data);
typedef OnMutationCompleted$Mutation$markPayoutAccountAsDefault = FutureOr<void>
    Function(
  Map<String, dynamic>?,
  Mutation$markPayoutAccountAsDefault?,
);

class Options$Mutation$markPayoutAccountAsDefault
    extends graphql.MutationOptions<Mutation$markPayoutAccountAsDefault> {
  Options$Mutation$markPayoutAccountAsDefault({
    String? operationName,
    required Variables$Mutation$markPayoutAccountAsDefault variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    Mutation$markPayoutAccountAsDefault? typedOptimisticResult,
    graphql.Context? context,
    OnMutationCompleted$Mutation$markPayoutAccountAsDefault? onCompleted,
    graphql.OnMutationUpdate<Mutation$markPayoutAccountAsDefault>? update,
        ...
        super(
          ...
          onCompleted: onCompleted == null
              ...
              : (data) => onCompleted(
                    ...
                    data == null
                        ? null
                        : _parserFn$Mutation$markPayoutAccountAsDefault(data),
                  ),
          update: update,
          onError: onError,
          document: documentNodeMutationmarkPayoutAccountAsDefault,
          parserFn: _parserFn$Mutation$markPayoutAccountAsDefault,
        );

  final OnMutationCompleted$Mutation$markPayoutAccountAsDefault?
...
class WatchOptions$Mutation$markPayoutAccountAsDefault
    extends graphql.WatchQueryOptions<Mutation$markPayoutAccountAsDefault> {
  WatchOptions$Mutation$markPayoutAccountAsDefault({
    String? operationName,
    required Variables$Mutation$markPayoutAccountAsDefault variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
extension ClientExtension$Mutation$markPayoutAccountAsDefault
    on graphql.GraphQLClient {
  Future<graphql.QueryResult<Mutation$markPayoutAccountAsDefault>>
      mutate$markPayoutAccountAsDefault(
              Options$Mutation$markPayoutAccountAsDefault options) async =>
          await this.mutate(options);
  graphql.ObservableQuery<Mutation$markPayoutAccountAsDefault>
      watchMutation$markPayoutAccountAsDefault(
              WatchOptions$Mutation$markPayoutAccountAsDefault options) =>

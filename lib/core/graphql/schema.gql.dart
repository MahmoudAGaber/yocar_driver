...
class Input$PayoutAccountSort {
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Input$PayoutAccountSort) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$field = field;
...
class Input$PayoutMethodSort {
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Input$PayoutMethodSort) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$field = field;
    ...
    if (data.containsKey('accountHolderDateOfBirth')) {
      ...
      result$data['accountHolderDateOfBirth'] =
          l$accountHolderDateOfBirth == null
              ? null
              : fromGraphQLTimestampToDartDateTime(l$accountHolderDateOfBirth);
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_$data.containsKey('accountHolderDateOfBirth')) {
      ...
      result$data['accountHolderDateOfBirth'] =
          l$accountHolderDateOfBirth == null
              ? null
              : fromDartDateTimeToGraphQLTimestamp(l$accountHolderDateOfBirth);
    }
    return result$data;
  }
...
class Input$CreatePayoutAccount {
  ...
  factory Input$CreatePayoutAccount.fromJson(Map<String, dynamic> data) {
    ...
    final l$driverId = data['driverId'];
    result$data['driverId'] = (l$driverId as num).toDouble();
  ...
  double get driverId => (_$data['driverId'] as double);
  ...
  TRes call({
    ...
    Object? linkType = _undefined,
      ...
      _then(Input$UpdatePayoutAccount._({
        ...
        if (accountHolderDateOfBirth != _undefined)
          'accountHolderDateOfBirth': (accountHolderDateOfBirth as DateTime?),
        if (driverId != _undefined) 'driverId': (driverId as double?),
        if (linkType != _undefined)
          'linkType': (linkType as Enum$GatewayLinkMethod?),
      }));
}
...
class Input$RiderReviewInput {
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Input$RiderReviewInput) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$score = score;
...
enum Enum$GatewayLinkMethod { none, redirect, manual, $unknown }
...
enum Enum$SavedPaymentMethodType { CARD, BANK_ACCOUNT, $unknown }
...
enum Enum$SavedPaymentMethodSortFields { id, driverId, $unknown }
...
enum Enum$TopUpWalletStatus { OK, Redirect, Failed, $unknown }
...
enum Enum$PayoutMethodType { Stripe, BankTransfer, $unknown }
...
enum Enum$PayoutAccountSortFields { id, driverId, $unknown }
...
enum Enum$PayoutMethodSortFields { id, $unknown }
...
enum Enum$OrderCancelReasonSortFields { id, isEnabled, userType, $unknown }

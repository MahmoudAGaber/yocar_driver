...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    PayoutAccountListRoute.name: (routeData) {
      final args = routeData.argsAs<PayoutAccountListRouteArgs>();
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: PayoutAccountListScreen(
          key: args.key,
...
class PayoutAccountListRoute extends PageRouteInfo<PayoutAccountListRouteArgs> {
  PayoutAccountListRoute({
    Key? key,
    required List<PayoutAccountEntity> methods,
    List<PageRouteInfo>? children,
  }) : super(
          PayoutAccountListRoute.name,
          args: PayoutAccountListRouteArgs(
            key: key,
            methods: methods,
          ),
          initialChildren: children,
  ...
  static const PageInfo<PayoutAccountListRouteArgs> page =
      PageInfo<PayoutAccountListRouteArgs>(name);
}

class PayoutAccountListRouteArgs {
  const PayoutAccountListRouteArgs({
    this.key,
  ...
  @override
  String toString() {
    return 'PayoutAccountListRouteArgs{key: $key, methods: $methods}';
  }
}

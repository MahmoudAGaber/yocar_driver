                ...
                child: BlocBuilder<PayoutAccountsBloc, PayoutAccountsState>(
                  builder: (context, state) {
                    switch (state) {
                      ...
                      case LoadedState(:final defaultMethod, :final linkedMethods):
                        return Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 400),
                              child: defaultMethod.toSavedCard(
                              ...
                              child: Column(
                                children: [
                                  ListView.separated(
                                    ...
                                    itemCount: linkedMethods.length,
                                    shrinkWrap: true,
                                    ...
                                    itemBuilder: (context, index) => AppMenuItem(
                                      ...
                                      title: linkedMethods[index].bankName ?? "",
                                      subtitle: linkedMethods[index].accountNumber,
                                      onPressed: () async {
                                        await context.router.push(
                                          PayoutAccountListRoute(
                                            methods: [defaultMethod, ...linkedMethods],
                                          ),
                                        );
                                        locator<PayoutAccountsBloc>().load();
                                      },

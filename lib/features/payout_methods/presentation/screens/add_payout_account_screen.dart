          ...
          child: BlocConsumer<AddBankTransferPayoutMethodFormCubit, AddBankTransferPayoutMethodFormState>(
            listener: (context, state) {
              state.pageState.mapOrNull(
                ...
                error: (value) => context.showSnackBar(message: value.message),
              );
            },
                        ...
                        child: Column(
                          ...
                          children: [
                            AppFormField(
                              ...
                              onSaved: cubit.onAccountHolderNameChanged,
                            ),
                            const SizedBox(
                              height: 16,
                            ),
                            AppFormField(
                              ...
                              onSaved: cubit.onRoutingNumberChanged,
                            ),
                            const SizedBox(
                              height: 16,
                            ),
                            AppFormField(
                              ...
                              onSaved: cubit.onAccountNumberChanged,
                            ),
                            const SizedBox(
                              height: 16,
                            ),
                            AppFormField(
                              ...
                              onSaved: cubit.onBankNameChanged,
                            ),
                            const SizedBox(
                              height: 16,
                            ),
                            AppFormField(
                              ...
                              onSaved: cubit.onBranchNameChanged,
                            ),
                            const SizedBox(
                              height: 16,
                            ),
                            ...
                            AppFormField(
                              ...
                              onSaved: cubit.onAccountHolderStateChanged,
                            ),
                            const SizedBox(
                              height: 16,
                            ),
                            AppFormField(
                              ...
                              onSaved: cubit.onAccountHolderCityChanged,
                            ),
                            const SizedBox(
                              height: 16,
                            ),
                            AppFormField(
                              ...
                              onSaved: cubit.onAccountHolderAddressChanged,
                            ),
                            const SizedBox(
                              height: 16,
                            ),
                            AppFormField(
                              ...
                              onSaved: cubit.onAccountHolderZipCodeChanged,
                            ),
                            const SizedBox(
                              height: 16,
                            ),

...
class _FeedbacksSummaryScreenState extends State<FeedbacksSummaryScreen> {
  ...
  void initState() {
    super.initState();
    locator<FeedbacksSummaryCubit>().load();
  }
                      ...
                      loaded: (loaded) {
                        return SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              RatingGauge(rating: loaded.summary.averageRating ?? 0),
                              const SizedBox(
                                height: 16,
                              ),
                              if (loaded.summary.averageRating != null) ...[
                                Center(
                                  child: Text(
                                    ratingTitle(context, loaded.summary.averageRating!),
                                ...
                                Center(
                                  child: Text(
                                    ratingSubtitle(context, loaded.summary.averageRating!),
                              ...
                              Wrap(
                                ...
                                children: loaded.summary.goodPoints
                                    .map(
                                      (e) => FeedbackParameter(
                                        isGood: true,
                                        title: e,
                              ...
                              Wrap(
                                ...
                                runSpacing: 8,
                                alignment: WrapAlignment.start,
                                children: loaded.summary.badPoints
                                    .map(
                                      (e) => FeedbackParameter(
                                        isGood: false,
                                        title: e,

...
class _$LoginStateImpl extends _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(isLoading: $isLoading, errorMessage: $errorMessage, loginPage: $loginPage, countryCode: $countryCode, verificationHash: $verificationHash, jwtToken: $jwtToken, currentPassword: $currentPassword, otp: $otp, newPassword: $newPassword, mobileNumber: $mobileNumber, vehicleModels: $vehicleModels, vehicleColors: $vehicleColors, profileFullEntity: $profileFullEntity)';
  }

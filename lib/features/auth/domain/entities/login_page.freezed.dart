...
mixin _$LoginPage {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function() enterOtp,
...
class _$EnterOtpPageImpl extends EnterOtpPage {
  const _$EnterOtpPageImpl({final String? $type})
      : $type = $type ?? 'enterOtp',
        super._();
  ...
  @override
  String toString() {
    return 'LoginPage.enterOtp()';
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$EnterOtpPageImpl);
  }
...
abstract class EnterOtpPage extends LoginPage {
  const factory EnterOtpPage() = _$EnterOtpPageImpl;
